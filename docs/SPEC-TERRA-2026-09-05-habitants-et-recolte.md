...
- Une carotte consommée restaure un point, sans dépasser 10. Chaque habitant peut récupérer au maximum **2 points par alimentation entre deux repos qualifiants**. Le quota est réinitialisé après **5 heures continues de repos**. Arbitrage du 7 septembre : atteindre 10 réveille immédiatement ; un repos plus court conserve le quota consommé. Une micro-sieste ne réinitialise rien.
