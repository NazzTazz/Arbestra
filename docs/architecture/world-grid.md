...
Le tore 3D futur est une représentation de dézoom. Les règles, collisions et déplacements restent calculés sur la grille plate. Streaming de chunks, rendu planète-donut et génération serveur sont volontairement reportés.
